...
func (in *RecommendationSpec) DeepCopyInto(out *RecommendationSpec) {
	*out = *in
	if in.VulnerabilityReport != nil {
		in, out := &in.VulnerabilityReport, &out.VulnerabilityReport
...
func (in *RecommendationStatus) DeepCopyInto(out *RecommendationStatus) {
	*out = *in
	...
	if in.CreatedOperationRef != nil {
		in, out := &in.CreatedOperationRef, &out.CreatedOperationRef
